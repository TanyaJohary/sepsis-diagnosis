...
###############################################################################
data <- read.csv("septicyteGSE185263.csv")
...
ggsave("top_feature_importance_plot_SMOTE_GSE185263.png", 
...
ggsave("feature_removal_mcc_plot_SMOTE_GSE185263.png", 
...
ggsave("noise_plot_GSE185263.png", 
