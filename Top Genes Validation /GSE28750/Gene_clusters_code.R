...
write.csv(topgenes, "topgenes_GSE28750.csv",row.names = FALSE)
...
write.csv(cluster1, "cluster1_GSE28750.csv",row.names = FALSE)
##################################################################### cluster2
...
write.csv(cluster2, "cluster2_GSE28750.csv",row.names = FALSE)
##################################################################### cluster3
...
write.csv(cluster3, "cluster3_GSE28750.csv",row.names = FALSE)
