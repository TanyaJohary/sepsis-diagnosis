...
write.csv(topgenes, "topgenes_GSE100159.csv",row.names = FALSE)
...
write.csv(cluster1, "cluster1_GSE100159.csv",row.names = FALSE)
##################################################################### cluster2
...
write.csv(cluster2, "cluster2_GSE100159.csv",row.names = FALSE)
##################################################################### cluster3
...
write.csv(cluster3, "cluster3_GSE100159.csv",row.names = FALSE)
