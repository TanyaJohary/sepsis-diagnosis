...
write.csv(topgenes, "topgenes_GSE243217.csv",row.names = FALSE)
...
write.csv(cluster1, "cluster1_GSE243217.csv",row.names = FALSE)
##################################################################### cluster2
...
write.csv(cluster2, "cluster2_GSE243217.csv",row.names = FALSE)
##################################################################### cluster3
...
write.csv(cluster3, "cluster3_GSE243217.csv",row.names = FALSE)
