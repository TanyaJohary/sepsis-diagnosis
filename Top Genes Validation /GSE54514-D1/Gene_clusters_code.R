...
write.csv(topgenes, "topgenes_D1_GSE54514.csv",row.names = FALSE)
...
write.csv(cluster1, "cluster1_D1_GSE54514.csv",row.names = FALSE)
##################################################################### cluster2
...
write.csv(cluster2, "cluster2_D1_GSE54514.csv",row.names = FALSE)
##################################################################### cluster3
...
write.csv(cluster3, "cluster3_D1_GSE54514.csv",row.names = FALSE)
