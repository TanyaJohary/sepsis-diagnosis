...
# 2. Read Input Data
###############################################################################
mann_whitney_results <- read_csv("mann_whitney_results_adjusted_T1_GSE69063.csv")
rf_importance        <- read_csv("average_feature_importance_SMOTE_T1_GSE69063.csv")

data <- read.csv("T1_sepsis_dataGSE69063.csv")
...
write_csv(mann_whitney_ranking, "mann-w-rankingT1-GSE69063.csv")
...
write_csv(rf_ranking, "rf-rankingT1-GSE69063.csv")
###############################################################################
...
write_csv(merged_ranking, "merged_rankings_comparison_T1_GSE69063.csv")
...
write_csv(cor_test_results, "correlation_test_results_T1_GSE69063.csv")
...
ggsave("comparison_ranks_T1_GSE69063.png", p_comparison, width = 6, height = 5, dpi = 300)
print(p_comparison)
...
ggsave("hist_rank_diff_T1_GSE69063.png", p_hist_diff, width = 6, height = 4, dpi = 300)
print(p_hist_diff)
...
ggsave("bar_top_discrepancies_T1_GSE69063.png", p_bar_diff, width = 6, height = 4, dpi = 300)
print(p_bar_diff)
...
ggsave("hist_mannwhitney_pvals_T1_GSE69063.png", p_hist_pval, width = 6, height = 4, dpi = 300)
print(p_hist_pval)
...
ggsave("scatter_pval_importance_labeled_T1_GSE69063.png", p_scatter_pval_importance_labeled, width = 7, height = 5, dpi = 300)
...
write.csv(data.frame(OverlapGenes = overlap_genes),
          "top10_overlap_genes_T1_GSE69063.csv",
          row.names = FALSE)
...
write.csv(boot_res$t, "boot_spearman_samples_T1_GSE69063.csv", row.names=FALSE)
