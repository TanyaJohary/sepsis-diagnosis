...
write.csv(all_feature_importance, "feature_importance_SMOTE_GSE28750.csv", row.names = FALSE)
...
write.csv(avg_importance, "average_feature_importance_SMOTE_GSE28750.csv", row.names = FALSE)
...
ggsave("top_feature_importance_plot_SMOTE_GSE28750.png", 
...
ggsave("feature_removal_mcc_plot_SMOTE_GSE28750.png", 
...
write.csv(gene_importance, "average_feature_importance_SMOTE_GSE28750.csv", row.names = FALSE)
