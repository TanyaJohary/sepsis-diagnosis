...
###############################################################################
write.csv(results, "repeated_splits_noSMOTE_GSE154918.csv", row.names = FALSE)
...
write.csv(average_metrics_df, "average_metrics_noSMOTE_GSE154918.csv", row.names = FALSE)

write.csv(all_feature_importance, "feature_importance_noSMOTE_GSE154918.csv", row.names = FALSE)
...
write.csv(avg_importance, "average_feature_importance_noSMOTE_GSE154918.csv", row.names = FALSE)
...
ggsave("top_feature_importance_plot_noSMOTE_GSE154918.png", 
...
write.csv(feature_removal_results, "feature_removal_results_noSMOTE_GSE154918.csv", row.names = FALSE)
...
ggsave("feature_removal_mcc_plot_noSMOTE_GSE154918.png", 
...
write.csv(sanity_check_results, "sanity_check_results_noSMOTE_GSE154918.csv", row.names = FALSE)
...
ggsave("noise_plot_noSMOTE_GSE154918.png", 
