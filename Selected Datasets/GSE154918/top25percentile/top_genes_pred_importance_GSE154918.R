...
final_merged <- read.csv("~/sepsis/effect_size/final_merged_with_effect_sizes_GSE154918.csv", sep = " ")
...
print(median_pred_imp)  # Above this = above-average importance # 0.7783118
print(top25_pred_imp)   # Above this = top 25% most important genes # 1.136023 
...
write.csv(top_genes, "top_25_percent_genes_GSE154918.csv", row.names = FALSE, quote = FALSE)
