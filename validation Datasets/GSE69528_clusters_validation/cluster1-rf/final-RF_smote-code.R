...
###############################################################################
data <- read.csv("cluster1_GSE69528.csv")
...
###############################################################################
write.csv(results, "repeated_splits_SMOTE_cluster1GSE69528.csv", row.names = FALSE)
...
write.csv(average_metrics_df, "average_metrics_SMOTE_cluster1GSE69528.csv", row.names = FALSE)

# Save feature importance data
write.csv(all_feature_importance, "feature_importance_SMOTE_cluster1GSE69528.csv", row.names = FALSE)
...
write.csv(avg_importance, "average_feature_importance_SMOTE_cluster1GSE69528.csv", row.names = FALSE)
...
ggsave("top_feature_importance_plot_SMOTE_cluster1GSE69528.png", 
...
write.csv(feature_removal_results, "feature_removal_results_SMOTE_cluster1GSE69528.csv", row.names = FALSE)
...
ggsave("feature_removal_mcc_plot_SMOTE_cluster1GSE69528.png", 
...
write.csv(sanity_check_results, "sanity_check_results_SMOTE_cluster1GSE69528.csv", row.names = FALSE)
...
ggsave("noise_plot_cluster1GSE69528.png", 
