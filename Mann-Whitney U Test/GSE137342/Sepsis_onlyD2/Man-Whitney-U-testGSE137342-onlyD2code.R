...
# Load the dataset
data <- read.csv("sepsis_onlyD2_GSE137342_10558.csv")
...
write.csv(mann_whitney_results, "mann_whitney_results_adjustedGSE137342-olyD2.csv", row.names = FALSE)
...
write.csv(significant_genes, "significant_genesGSE137342-onlyD2.csv", row.names = FALSE)
...
write.csv(non_significant_genes, "non_significant_genesGSE137342-onlyD2.csv", row.names = FALSE)
...
if (nrow(significant_genes) > 0) {
  ...
  ggsave("significant_genes_boxplot_orderedGSE137342-onlyD2.png", plot = p, width = 12, height = 8)
