...
write.csv(mann_whitney_results, "mann_whitney_results_adjustedGSE28750.csv", row.names = FALSE)
...
write.csv(significant_genes, "significant_genesGSE28750.csv", row.names = FALSE)
...
write.csv(non_significant_genes, "non_significant_genesGSE28750.csv", row.names = FALSE)
...
if (nrow(significant_genes) > 0) {
  ...
  ggsave("significant_genes_boxplot_ordered.png", plot = p, width = 12, height = 8)
