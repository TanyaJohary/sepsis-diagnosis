...
# Save full results
write.csv(mann_whitney_results, "mann_whitney_results_adjusted_GSE234217.csv", row.names = FALSE)
...
write_csv(significant_genes,"significant_genes_GSE234217.csv")
write_csv(non_significant_genes, "non_significant_genes_GSE234217.csv")
...
if (nrow(significant_genes) > 0) {
  ...
  print(p)
  ggsave("top_10_significant_genes_boxplot_GSE234217.png",
...
# Display and save
print(volcano_plot)
ggsave("volcano_plot_only_highly_labeled_GSE243217.png", volcano_plot,
