...
final_merged <- read.csv("~/sepsis/effect_size/final_merged_with_effect_sizes_GSE131761.csv", sep = " ")
...
write.csv(top_genes, "top_25_percent_genes_GSE131761.csv", row.names = FALSE, quote = FALSE)
