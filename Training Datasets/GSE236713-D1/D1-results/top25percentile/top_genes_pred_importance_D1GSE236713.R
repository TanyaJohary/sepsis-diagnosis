...
final_merged <- read.csv("~/sepsis/effect_size/final_merged_with_effect_sizes_D1GSE236713.csv", sep = " ")
...
print(median_pred_imp)  # Above this = above-average importance
print(top25_pred_imp)   # Above this = top 25% most important genes
...
write.csv(top_genes, "top_25_percent_genes_D1GSE236713.csv", row.names = FALSE, quote = FALSE)
