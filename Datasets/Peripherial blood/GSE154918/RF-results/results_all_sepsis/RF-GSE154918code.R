...
for (i in 1:n_repeats) {
  ...
  predictions <- ifelse(probs > 0.5, "Sepsis", "Healthy control")
...
write.csv(results, "repeated_splits_metrics_all_GSE154918.csv", row.names = FALSE)
...
write.csv(average_metrics_df, "average_metrics_all_GSE154918.csv", row.names = FALSE)
cat("Average metrics saved to 'average_metrics_all_GSE154918.csv'\n")

################################################################################
# Save Feature Importance (Gini)
################################################################################
write.csv(all_gini_importance, "gini_feature_importance_all_GSE154918.csv", row.names = FALSE)
cat("Feature importance results saved to 'gini_feature_importance_all_GSE154918.csv'\n")
...
write.csv(avg_gini_importance, "average_gini_importance_all_GSE154918.csv", row.names = FALSE)
cat("Average feature importance saved to 'average_gini_importance_all_GSE154918.csv'\n")
...
print(gini_plot)
ggsave("top_gini_importance_plot_all_GSE154918.png", plot = gini_plot, width = 12, height = 7, dpi = 300)
...
write.csv(feature_removal_results, "feature_removal_results_all_GSE154918.csv", row.names = FALSE)
...
ggsave("mcc_feature_importance_ordered.png", plot = mcc_plot, width = 12, height = 8, dpi = 300)
...
write.csv(sanity_check_results, "sanity_check_results_all_GSE154918.csv", row.names = FALSE)
...
print(noise_plot)
ggsave("improved_noise_plot_GSE154918.png", plot = noise_plot, width = 10, height = 6, dpi = 300)
