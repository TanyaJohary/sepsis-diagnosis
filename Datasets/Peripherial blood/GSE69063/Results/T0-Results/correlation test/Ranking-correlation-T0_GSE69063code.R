...
# 2. Read Input Data
###############################################################################
mann_whitney_results <- read_csv("mann_whitney_results_adjusted_T0_GSE69063.csv")
rf_importance        <- read_csv("average_feature_importance_SMOTE_T0_GSE69063.csv")

data <- read.csv("T0_sepsis_dataGSE69063.csv")
...
write_csv(mann_whitney_ranking, "mann-w-rankingT0-GSE69063.csv")
...
write_csv(rf_ranking, "rf-rankingT0-GSE69063.csv")
###############################################################################
...
# (c) Save final table
write_csv(final_merged, "final_merged_with_effect_sizes_T1_GSE69063.csv")
...
ggsave("venn_top10_mw_rf_T0GSE69063.png", p_venn, width = 5, height = 4, dpi = 300)
print(p_venn)
