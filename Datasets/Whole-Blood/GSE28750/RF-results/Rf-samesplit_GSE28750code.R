...
write.csv(results, "repeated_splits_metrics_GSE28750.csv", row.names = FALSE)
...
cat("Average metrics saved to 'average_metrics_GSE28750.csv'\n")
...
ggsave("feature_removal_mcc_plot_GSE28750.png", width = 10, height = 12, dpi = 300)
...
print(noise_plot)
ggsave("impact_of_noise_on_model_performance_GSE28750.png",
