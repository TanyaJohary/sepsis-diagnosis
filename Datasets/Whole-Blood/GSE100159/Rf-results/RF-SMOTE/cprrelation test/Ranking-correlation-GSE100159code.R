...
# 2. Read Input Data
###############################################################################
mann_whitney_results <- read_csv("mann_whitney_results_adjusted_GSE100159.csv")
rf_importance        <- read_csv("average_feature_importance_SMOTE_GSE100159.csv")
...
write_csv(mann_whitney_ranking, "mann-w-ranking_GSE100159.csv")
...
# (c) Save final table
write_csv(final_merged, "final_merged_with_effect_sizes_GSE100159.csv")
