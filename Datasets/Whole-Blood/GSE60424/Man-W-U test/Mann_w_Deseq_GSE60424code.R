...
# Save results
write.csv(mann_whitney_results, "mann_whitney_results_adjusted_GSE604242.csv", row.names = FALSE)
...
write_csv(significant_genes, "significant_genes_GSE604242.csv")
write_csv(non_significant_genes, "non_significant_genes_GSE60424.csv")
...
if (nrow(significant_genes) > 0) {
  ...
  print(p)
  ggsave("top_25_significant_genes_boxplot_GSE60424.png", plot = p, width = 14, height = 10, dpi = 300)
