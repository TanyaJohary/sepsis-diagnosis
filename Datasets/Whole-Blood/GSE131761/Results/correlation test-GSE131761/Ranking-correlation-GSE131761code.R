...
# 2. Read Input Data
###############################################################################
mann_whitney_results <- read_csv("mann_whitney_results_adjusted_GSE131761.csv")
rf_importance        <- read_csv("average_feature_importance_SMOTE_GSE131761.csv")

data <- read.csv("septic_dataGSE131761.csv")
data$Label <- factor(data$Label, levels = c("control patient", "septic shock"))
...
write_csv(mann_whitney_ranking, "mann-w-ranking_GSE131761.csv")
...
# (c) Save final table
write_csv(final_merged, "final_merged_with_effect_sizes_GSE131761.csv")
