...
################################################################################
data <- read.csv("sepsis_onlyD1_GSE137342_10558.csv")
...
write.csv(results, "repeated_splits_metrics_onlyD1_60.csv", row.names = FALSE)
...
write.csv(average_metrics_df, "average_metrics_onlyD1_60.csv", row.names = FALSE)

# Print confirmation
cat("Average metrics saved to 'average_metrics_onlyD1_60.csv'\n")
...
write.csv(feature_removal_results, "feature_removal_results_onlyD1_60.csv", row.names = FALSE)
...
ggsave("feature_removal_mcc_plot_onlyD1_60.png", width = 10, height = 12, dpi = 300)
...
write.csv(sanity_check_results, "sanity_check_results_onlyD1_60.csv", row.names = FALSE)
...
print(noise_plot)
ggsave("impact_of_noise_on_model_performance_onlyD1_60.png", plot = noise_plot, width = 10, height = 6, dpi = 300)
