...
write.csv(results, "repeated_splits_metrics_allD1_60.csv", row.names = FALSE)
...
write.csv(average_metrics_df, "average_metrics_allD1_60.csv", row.names = FALSE)

# Print confirmation
cat("Average metrics saved to 'average_metrics_allD1_60.csv'\n")
...
write.csv(feature_removal_results, "feature_removal_results_allD1_60.csv", row.names = FALSE)
...
ggsave("feature_removal_mcc_plot_allD1_60.png", width = 10, height = 12, dpi = 300)
...
write.csv(sanity_check_results, "sanity_check_results_allD1_60.csv", row.names = FALSE)
...
print(noise_plot)
ggsave("impact_of_noise_on_model_performance_allD1_60.png", plot = noise_plot, width = 10, height = 6, dpi = 300)
