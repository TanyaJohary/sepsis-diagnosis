...
write.csv(results, "repeated_splits_metricsGSE13015-6947.csv", row.names = FALSE)
# Average metrics
...
write.csv(average_metrics_df, "average_metricsGSE13015-6947.csv", row.names = FALSE)
...
write.csv(feature_removal_results, "feature_removal_resultsGSE13015-6947.csv", row.names = FALSE)
...
ggsave("feature_removal_mcc_plotGSE13015-6947.png", width = 10, height = 12, dpi = 300)
...
write.csv(sanity_check_results, "sanity_check_resultsGSE13015-6947.csv", row.names = FALSE)
...
print(noise_plot)
ggsave("impact_of_noise_on_model_performanceGSE13015-6947.png", plot = noise_plot, width = 10, height = 6, dpi = 300)
