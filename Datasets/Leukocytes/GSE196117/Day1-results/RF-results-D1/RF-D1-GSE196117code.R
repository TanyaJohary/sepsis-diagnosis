...
###############################################################################
data <- read.csv("sepsis_D1_dataGSE196117.csv")
...
###############################################################################
write.csv(results, "repeated_splits_D1_GSE196117.csv", row.names = FALSE)
...
write.csv(average_metrics_df, "average_metrics_D1_GSE196117.csv", row.names = FALSE)

# Save feature importance data
write.csv(all_feature_importance, "feature_importance_D1_GSE196117.csv", row.names = FALSE)
...
write.csv(avg_importance, "average_feature_importance_D1_GSE196117.csv", row.names = FALSE)
...
ggsave("top_feature_importance_plot_D1_GSE196117.png", 
...
write.csv(feature_removal_results, "feature_removal_results_D1_GSE196117.csv", row.names = FALSE)
...
ggsave("feature_removal_mcc_D1_GSE196117.png",
...
write.csv(sanity_check_results, "sanity_check_results_D1_GSE196117.csv", row.names = FALSE)
...
ggsave("noise_plot_D1_GSE196117.png",
