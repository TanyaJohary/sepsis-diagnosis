...
# Save full results
write.csv(mann_whitney_results, "mann_whitney_results_adjusted_D5_GSE236713.csv", row.names = FALSE)
...
write_csv(significant_genes,"significant_genes_D5_GSE236713.csv")
write_csv(non_significant_genes, "non_significant_genes_D5_GSE236713.csv")
...
if (nrow(significant_genes) > 0) {
  ...
  print(p)
  ggsave("top_25_significant_genes_boxplot_D5_GSE236713.png",
